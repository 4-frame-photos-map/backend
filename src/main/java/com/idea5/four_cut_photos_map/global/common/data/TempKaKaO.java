...
//    }
    ...
    static List<ShopDto> sampleData(){
        List<ShopDto> shops = new ArrayList<>();
        shops.add(new ShopDto("인생네컷","인생네컷 강남점", "서울 강남구~", 12.3, 15.2, 100));
        shops.add(new ShopDto("하루필름", "하루필름 강남점", "서울 강남구", 13.23, 18.2, 200));
        shops.add(new ShopDto("하루필름", "하루필름 홍대점", "서울 강남구", 13.23, 18.2, 200));
        shops.add(new ShopDto("포토이즘", "포토이즘 강남점", "서울 강남구", 19.23, 11.32, 300));
        shops.add(new ShopDto("브랜드1", "브랜드1 강남점", "서울 강남구", 19.23, 11.32, 300));
        shops.add(new ShopDto("브랜드2", "브랜드2 강남점", "서울 강남구", 20.23, 11.32, 300));
        return shops;
    }
}
