...
public class TempKaKaO {
    public static List<ShopDto> tempDataBySearch(String keyword){
        ...
        for (ShopDto shop : sampleData()) {
            if(shop.getName().equals(keyword)){
                shops.add(shop);
            }
        }
        return shops;
...
//    }
    ...
    static List<ShopDto> sampleData(){
        List<ShopDto> shops = new ArrayList<>();
        shops.add(new ShopDto("인생네컷 강남점", "서울 강남구~", 12.3, 15.2, "200m"));
        shops.add(new ShopDto("하루필름 강남점", "서울 강남구", 13.23, 18.2, "2km"));
        shops.add(new ShopDto("하루필름 홍대점", "서울 강남구", 13.23, 18.2, "3km"));
        shops.add(new ShopDto("포토이즘 강남점", "서울 강남구", 19.23, 11.32, "4km"));
        shops.add(new ShopDto("브랜드1 강남점", "서울 강남구", 19.23, 11.32, "5km"));
        shops.add(new ShopDto("브랜드2 강남점", "서울 강남구", 20.23, 11.32, "6km"));
        return shops;
    }
}
